  ...
  <div class="container">
    <div class="row"><br>
      <div class="col-sm-4"></div>
        <div class="col-sm-4 text-center"style="background-color:#990707;"><br>

        	<h1 align="center"><b><font style="font-family: 'Libre Baskerville', serif;;">User Login ?</font></b></h1>
          ...
          <div class="form-group forget">
                <a href="Forgot account.php">Forget Account</a>&nbsp; &nbsp; 
